...
In this section, I explain the importance of a note-taking system. This is the base of everything. We will only start learning about all of these when we have our note-taking in order. 
...
5) Click the icon on the Top Left Corner named Collapse, expand it.
6) Click on Settings
7) Go to Appearance
8) Browse Themes and Pick as per your taste. I use and would recommend Prism
...
This work is licensed under a [Creative Commons 1.0 Universal (CC0-1.0) License](https://creativecommons.org/publicdomain/zero/1.0/legalcode.en).
