...
Since, we are doing **NodePort** `svc`, doesn't mean it creates **ClusterIP**. It creates **ClusterIP** and yes, it it possible to use the same to expose application out to the internet. 
