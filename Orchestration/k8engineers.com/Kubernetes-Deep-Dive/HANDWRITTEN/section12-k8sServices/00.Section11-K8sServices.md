...
WHAT TO DO? in that case, use **==`dns names.`==** PRIORITY AND RECOMMENDED WAY TO `PING` AND COMMUNICATE WITH THE `svc`. 
*can use IP but by any chance if get recreated, IP will be puff. 
