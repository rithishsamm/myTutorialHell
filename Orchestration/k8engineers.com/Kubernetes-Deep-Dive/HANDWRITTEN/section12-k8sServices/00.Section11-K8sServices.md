...
![[svc.excalidrawYaml]]
WHAT IS TE KEY COMPONENT HERE FOR THESE INDIVIDUAL ELEMENTS TO WORK WITH EACH OTHER: **==SELECTOR==**
...
The easiest way to configure a load balancer is of using `service`, these applies to all the workload supports `replication` and voila!
