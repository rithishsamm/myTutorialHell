...
This is not a wise choice if you want the data to be persistent since the `emptyDir()` is totally ephemeral. 

If we happened to migrate these workloads from one to to other, its a brand new directory 



**Practical's: `EmptyDir()`**
