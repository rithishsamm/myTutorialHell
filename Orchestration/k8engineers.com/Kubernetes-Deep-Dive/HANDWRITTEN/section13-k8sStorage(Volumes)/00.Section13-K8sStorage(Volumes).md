...
There are some Pod-level fields, you can provide them to a container either as an **environment variable** or using a **`downwardAPI` volume**
...
# 12 . **resourceFieldRef** *`downwardAPI`*: Demo and overview
