...
We saw how to deploy apps using pods and exposing the same in and out of the K8s Cluster by defining all that in a container section on the PODs Manifest YAML file.
