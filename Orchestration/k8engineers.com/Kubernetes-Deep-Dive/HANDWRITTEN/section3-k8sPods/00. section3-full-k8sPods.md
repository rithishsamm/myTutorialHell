...
Next Scenario: If i want to access application outside the kubernetes clusters if my applications are deployed as a pod inside a container. HOW TO MAKE THIS PUBLICLY AVAILABLE TO THE PUBLIC USERS. 
![[Pasted image 20240909175410.png]]


If writing port section, these fields/parameters are mandatory to be grasped.
![[Pasted image 20240909180131.png]]
